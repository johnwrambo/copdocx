...
var bookingWorkflow = read("functions/application/booking.js");
...
check("booking workflow records officer field arrests", bookingWorkflow.indexOf("deps.getOfficers().recordFieldArrest") !== -1);
